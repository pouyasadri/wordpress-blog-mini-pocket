class WpConfig {
  // YOUR WEBISTE URL
  static const String websiteUrl = "https://livepunjabitv.com/";

  // CREDENTIALS
  static const String websiteAdminName = 'myuser';
  static const String websiteAdminPassword = 'Passcode@9876';

  //FEATURE TAG ID
  static const int featuredTagID = 92;

  //VIDEO TAG ID
  static const int videoTagId = 93;
